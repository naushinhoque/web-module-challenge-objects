...
function getReviewByIndex(array, number) {
  return `${array[number].name} gave the resturaunt a ${array[number].rating} star review and their feedback was: ${array[number.feedback]}`;  
}
